...
namespace EW.Utility.ObjectModel.Events
{
    public class MyEventPactEnded : AMyEvent
    {
        ...
        public override string ToString() => $"Закончился мирный договор между фракциями «{MySave.Factions.Find(x => x.Tag == Politic.Factions.Item1).Name}» и «{MySave.Factions.Find(x => x.Tag == Politic.Factions.Item2).Name}»";
    }
}
