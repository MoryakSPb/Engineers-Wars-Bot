...
namespace EW.ObjectModel
{
    ...
    {
        static public readonly IReadOnlyDictionary<ShipType, (MyResourses Cost, MyResourses Service)> Ships = new Dictionary<ShipType, (MyResourses Cost, MyResourses Service)>(2)
                                                                                                              {
                                                                                                                  {
        ...
        static public readonly IReadOnlyDictionary<SectorType, (MyResourses Service, bool Improvementable)> Sectors = new Dictionary<SectorType, (MyResourses Service, bool Improvementable)>(2)
                                                                                                                      {
                                                                                                                          {
        ...
        static public readonly IReadOnlyDictionary<(SectorImprovementType Type, int Level), (bool buyable, MyResourses Cost, MyResourses Service)> SectorImprovements = new Dictionary<(SectorImprovementType Type, int Level), (bool buyable, MyResourses Cost, MyResourses Service )>(20)
                                                                                                                                                                        {
                                                                                                                                                                            ...
                                                                                                                                                                            {
                                                                                                                                                                                (SectorImprovementType.Storage, 2), (true, new MyResourses(600, 20, 5, 0, 0, 0), new MyResourses(-125, -10, 20, 0, 0, 0))
                                                                                                                                                                            },
                                                                                                                                                                            {
                                                                                                                                                                                (SectorImprovementType.Storage, 3), (true, new MyResourses(900, 10, 5, 1, 0, 0), new MyResourses(-250, -20, 30, 0, 0, 0))
                                                                                                                                                                            },
                                                                                                                                                                            {
        ...
        static public Dictionary<ShipType, int> GetNewEmptyShipDictionary()
        {
            ...
            foreach (KeyValuePair<ShipType, (MyResourses Cost, MyResourses Service)> item in Ships)
                dict.Add(item.Key, 0);
            return dict;
        }
    }
